							...
							<div class="row">	
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Status Masuk" name="status_masuk" value="0" class="col-xs-10 col-sm-9" readonly required/>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Nama Ayah" name="ayah" class="col-xs-10 col-sm-9" required/>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Pekerjaan" name="pekerjaan_a" class="col-xs-10 col-sm-9" required/>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Ibu" name="ibu" class="col-xs-10 col-sm-9" required/>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pekerjaan </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Pekerjaan" name="pekerjaan_i" class="col-xs-10 col-sm-9" required/>
										</div>
									</div>
								</div>
							</div>
...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","pages/siswa/getUnit.php?q="+str,true);
        xmlhttp.send();
		// console.log(#jum);
    }
}
...
function showLevel(str1) {
    if (str1 == "") {
        ...
        xmlhttp.open("GET","pages/siswa/getLevel.php?q="+str1,true);
        xmlhttp.send();
		// console.log(#jum);
    }
}
...
if (window.XMLHttpRequest) {
        ...
        xmlhttp.open("GET","pages/siswa/getTa.php",true);
        xmlhttp.send();
</script>
