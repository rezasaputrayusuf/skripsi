							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Nama" name="unit" value="<?=$unit?>" class="col-xs-10 col-sm-9" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Keterangan </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Pekerjaan" name="keterangan" value="<?=$keterangan?>" class="col-xs-10 col-sm-9" required/>
										</div>
									</div>
								</div>
							</div>
