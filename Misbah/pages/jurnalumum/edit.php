							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" name="item_bayar" value="<?=$item_bayar?>" class="col-xs-10 col-sm-9" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" name="biaya" value="<?=$biaya?>" class="col-xs-10 col-sm-9" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Sifat</label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" name="sifat" value="<?=$sifat?>" class="col-xs-10 col-sm-9" />
										</div>
									</div>
									<div class="form-group">
